...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-02-2023 a las 13:00:01
...
INSERT INTO `historyfilters` (`token`, `filters`, `dateSearch`) VALUES
(' 79.143.132.181 ', 'fuel,diesel:type_shifter,Manual', '2023-02-22 01:08:34'),
(' 79.143.132.181 ', 'fuel,diesel:type_shifter,Automatico', '2023-02-22 01:08:38');
...
--
ALTER TABLE `car`
  MODIFY `cod_car` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `image`
  MODIFY `cod_image` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de la tabla `location`
--
ALTER TABLE `location`
  MODIFY `cod_location` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
